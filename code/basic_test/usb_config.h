...
#define USB_PIN_DPU 5  // [0-7] GPIO for feeding the 1.5k Pull-Up on USB D- Pin; comment out if tied to 3V3
...
static const uint8_t device_descriptor[] = {
	...
	0x09, 0x12, //ID Vendor (0x1209 pid.codes shared VID)
	0x03, 0xd0, //ID Product (0xd003, shared with rv003usb demos)
	0x02, 0x00, //ID Rev
...
// Single vendor-defined feature report, ID 0xaa, 9 data bytes (10 total with ID)
// used as a simple bidirectional command/status mailbox.
...
static const uint8_t config_descriptor[] = {
	...
	7,            // endpoint descriptor (For endpoint 1, unused but required by HID class)
...
#define STR_MANUFACTURER u"OMNIXIE"
#define STR_PRODUCT      u"OMNIXIE Nixie Controller"
#ifndef STR_SERIAL
#define STR_SERIAL       u"OMNIXIE00001"
#endif
...
const static struct descriptor_list_struct {
	...
	{0x00002100, config_descriptor + 18, 9 }, // Useful for Windows + Android.
